document.addEventListener("DOMContentLoaded", function () {
    ...
    /*** 🔹 Product Pagination for Women Page ***/
    const products = [
        { img: "assets/kids.jpg", name: "Casual Top", oldPrice: "400 THB", newPrice: "350 THB" },
        { img: "assets/kids.jpg", name: "Summer Dress", price: "500 THB" }, // No discount
        { img: "assets/kids.jpg", name: "Skinny Jeans", price: "600 THB" },
        { img: "assets/kids.jpg", name: "High Heels", price: "1200 THB" },
        { img: "assets/kids.jpg", name: "Handbag", price: "800 THB" },
        { img: "assets/kids.jpg", name: "Denim Jacket", price: "900 THB" },
        { img: "assets/kids.jpg", name: "Silk Scarf", price: "300 THB" },
        { img: "assets/kids.jpg", name: "Elegant Watch", price: "1500 THB" },
        { img: "assets/kids.jpg", name: "Sun Hat", price: "250 THB" },
        { img: "assets/kids.jpg", name: "Designer Sunglasses", price: "850 THB" },
        { img: "assets/kids.jpg", name: "Pearl Earrings", price: "700 THB" },
        { img: "assets/kids.jpg", name: "Gold Ring", price: "1000 THB" },
        { img: "assets/kids.jpg", name: "Evening Gown", price: "1500 THB" },
        { img: "assets/kids.jpg", name: "Crop Top", price: "400 THB" },
        { img: "assets/kids.jpg", name: "Bootcut Jeans", price: "700 THB" },
        { img: "assets/kids.jpg", name: "Sneakers", price: "900 THB" },
        { img: "assets/kids.jpg", name: "Clutch", price: "600 THB" },
        { img: "assets/kids.jpg", name: "Leather Jacket", price: "1200 THB" },
        { img: "assets/kids.jpg", name: "Wool Scarf", price: "350 THB" },
        { img: "assets/kids.jpg", name: "Sport Watch", price: "800 THB" }
    ];
